SELECT b.organization_name, b.organization_type, b.facility_id, b.facility_name, 'Washers' AS "Type", a.id AS "machine_id", a.machine_type_id, a.machine_type, d.amount
